   ...
   public class GraphicElement extends EventDispatcher implements IGraphicElement, IInvalidating, ILayoutElement, IVisualElement, IMXMLObject
   {
      ...
      mx_internal function captureBitmapData(param1:Boolean = true, param2:uint = 4.294967295E9, param3:Boolean = true, param4:Rectangle = null) : BitmapData
      {
         ...
         if(!this.layoutFeatures || !this.layoutFeatures.is3D)
         {
            ...
            if(_loc10_ = !!param3 ? this.displayObject.transform.matrix : MatrixUtil.getConcatenatedMatrix(this.displayObject))
            {
      ...
      private function get3DSnapshot(param1:Boolean = true, param2:uint = 4.294967295E9, param3:Boolean = true) : BitmapData
      {
         ...
         if(_loc5_ is Group)
         {
            Group(_loc5_).$removeChild(this.displayObject);
         }
         else
         {
         ...
         if(_loc5_ is Group)
         {
            Group(_loc5_).$addChildAt(this.displayObject,_loc12_);
         }
         else
         {
      ...
      public function getBoundsXAtSize(param1:Number, param2:Number, param3:Boolean = true) : Number
      {
         ...
         var _loc6_:Point;
         if(!(_loc6_ = MatrixUtil.fitBounds(param1,param2,_loc5_,this.preferredWidthPreTransform(),this.preferredHeightPreTransform(),this.minWidth,this.minHeight,this.maxWidth,this.maxHeight)))
         {
      ...
      public function setLayoutBoundsSize(param1:Number, param2:Number, param3:Boolean = true) : void
      {
         ...
         else if(_loc6_ = MatrixUtil.fitBounds(param1,param2,_loc4_,this.preferredWidthPreTransform(),this.preferredHeightPreTransform(),this.minWidth,this.minHeight,this.maxWidth,this.maxHeight))
         {
            param1 = _loc6_.x;
            param2 = _loc6_.y;
         }
         ...
         if(this._width != param1 || this._height != param2)
         {
            ...
            if(param1 != _loc7_)
            {
               this.dispatchPropertyChangeEvent("width",_loc7_,param1);
            }
            if(param2 != _loc8_)
            {
               this.dispatchPropertyChangeEvent("height",_loc8_,param2);
            }
            this.invalidateDisplayList();
         }
      }
