      ...
      override public function measure() : void
      {
         ...
         while(_loc7_ < _loc6_)
         {
            if(!(!(_loc8_ = _loc1_.getElementAt(_loc7_)) || !_loc8_.includeInLayout))
            {
               ...
               {
                  _loc16_ = (_loc16_ = !!isNaN(_loc12_) ? Number(0) : Number(_loc12_)) + (!!isNaN(_loc13_) ? 0 : _loc13_);
               }
               else
               {
               ...
               {
                  _loc17_ = (_loc17_ = !!isNaN(_loc14_) ? Number(0) : Number(_loc14_)) + (!!isNaN(_loc15_) ? 0 : _loc15_);
               }
               else
               {
