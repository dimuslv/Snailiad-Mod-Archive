...
package org.flixel
{
   ...
   public class FlxPreloader extends MovieClip
   {
      ...
      protected function create() : void
      {
         ...
         _loc1_.alpha = 0.25;
         this._buffer.addChild(_loc1_);
         this.fglTextFormat = new TextFormat();
         this.fglTextFormat.color = 16777215;
         this.fglTextFormat.size = 24;
         this.fglTextFormat.align = "center";
         this.fglTextFormat.bold = true;
         this.fglTextFormat.font = "system";
         this.fglTextField = new TextField();
         this.fglTextField.width = stage.stageWidth - 16;
         this.fglTextField.height = stage.stageHeight - 16;
         this.fglTextField.y = 8;
         this.fglTextField.multiline = true;
         this.fglTextField.wordWrap = true;
         this.fglTextField.embedFonts = true;
         this.fglTextField.defaultTextFormat = this.fglTextFormat;
         this.fglTextField.text = "";
         addChild(this.fglTextField);
      }
