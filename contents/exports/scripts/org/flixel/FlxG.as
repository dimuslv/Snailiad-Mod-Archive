...
package org.flixel
{
   ...
   public class FlxG
   {
      ...
      public static function play(param1:Class, param2:Number = 0.75, param3:Boolean = false) : FlxSound
      {
         ...
         var _loc6_:FlxSound;
         (_loc6_ = sounds[_loc4_]).loadEmbedded(param1,param3);
      ...
      public static function stream(param1:String, param2:Number = 1.0, param3:Boolean = false) : FlxSound
      {
         ...
         var _loc6_:FlxSound;
         (_loc6_ = sounds[_loc4_]).loadStream(param1,param3);
         _loc6_.volume = param2;
         _loc6_.play();
         return _loc6_;
      }
      ...
      public static function addBitmap(param1:Class, param2:Boolean = false, param3:Boolean = false, param4:String = null) : BitmapData
      {
         ...
         var _loc6_:String;
         if((_loc6_ = param4) == null)
         {
            if((_loc6_ = String(param1)) == "[class SixMap3_Imgplayer]")
            {
            }
         ...
         if(_loc5_)
         {
            if(!_loc7_)
            {
               (_loc11_ = new BitmapData(_loc8_.width << 1,_loc8_.height,true,0)).draw(_loc8_);
