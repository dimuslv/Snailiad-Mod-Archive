...
package mx.styles
{
   ...
   public class StyleProtoChain
   {
      ...
      public static function initProtoChain(param1:IStyleClient) : void
      {
         ...
         var _loc11_:Object;
         if((_loc11_ = _loc2_.stylesRoot) && _loc11_.effects)
         {
         ...
         if(_loc12_)
         {
            if((_loc14_ = _loc12_.inheritingStyles) == StyleProtoChain.STYLE_UNINITIALIZED)
            {
               _loc14_ = _loc11_;
            }
            if(param1 is IModule)
            {
               if(_loc7_ = _loc2_.getStyleDeclaration("global"))
               {
                  _loc14_ = _loc7_.addStyleToProtoChain(_loc14_,DisplayObject(param1));
               }
            }
         }
         else if(_loc5_ && _loc5_.isPopUp)
         {
            if((_loc15_ = _loc5_._owner) && _loc15_ is IStyleClient)
            {
         ...
         {
            _loc3_ = (_loc13_ = getMatchingStyleDeclarations(_loc6_,_loc8_)) != null ? int(_loc13_.length) : 0;
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
               _loc14_ = (_loc7_ = _loc13_[_loc4_]).addStyleToProtoChain(_loc14_,_loc5_);
               _loc11_ = _loc7_.addStyleToProtoChain(_loc11_,_loc5_);
               if(_loc7_.effects)
               {
                  _loc6_.registerEffects(_loc7_.effects);
               }
               _loc4_++;
            }
         }
         else
         {
            if(_loc9_)
            {
               _loc3_ = (_loc16_ = _loc10_.split(/\s+/)).length;
               _loc4_ = 0;
               while(_loc4_ < _loc3_)
               {
                  if(_loc16_[_loc4_].length)
                  {
                     if(_loc7_ = _loc2_.getMergedStyleDeclaration("." + _loc16_[_loc4_]))
                     {
                        _loc8_.push(_loc7_);
                     }
                  }
            ...
            _loc3_ = (_loc13_ = param1.getClassStyleDeclarations()) != null ? int(_loc13_.length) : 0;
            _loc4_ = 0;
            while(_loc4_ < _loc3_)
            {
               _loc14_ = (_loc7_ = _loc13_[_loc4_]).addStyleToProtoChain(_loc14_,_loc5_);
               ...
               if(_loc7_.effects)
               {
                  param1.registerEffects(_loc7_.effects);
               }
               _loc4_++;
            }
            ...
            while(_loc4_ < _loc3_)
            {
               ...
               {
                  _loc14_ = _loc7_.addStyleToProtoChain(_loc14_,_loc5_);
                  _loc11_ = _loc7_.addStyleToProtoChain(_loc11_,_loc5_);
                  if(_loc7_.effects)
                  {
                     param1.registerEffects(_loc7_.effects);
         ...
         param1.inheritingStyles = !!_loc7_ ? _loc7_.addStyleToProtoChain(_loc14_,_loc5_) : _loc14_;
         param1.nonInheritingStyles = !!_loc7_ ? _loc7_.addStyleToProtoChain(_loc11_,_loc5_) : _loc11_;
      }
