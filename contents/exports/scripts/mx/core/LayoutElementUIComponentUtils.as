...
package mx.core
{
   ...
   public class LayoutElementUIComponentUtils
   {
      ...
      public static function getBoundsXAtSize(param1:IUIComponent, param2:Number, param3:Number, param4:Matrix) : Number
      {
         ...
         var _loc5_:Point;
         if(!(_loc5_ = MatrixUtil.fitBounds(param2,param3,param4,getPreferredUBoundsWidth(param1),getPreferredUBoundsHeight(param1),getMinUBoundsWidth(param1),getMinUBoundsHeight(param1),getMaxUBoundsWidth(param1),getMaxUBoundsHeight(param1))))
         {
