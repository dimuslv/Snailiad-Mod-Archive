...
package mx.utils
{
   ...
   public final class MatrixUtil
   {
      ...
      public static function fitBounds(param1:Number, param2:Number, param3:Matrix, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number, param9:Number) : Point
      {
         ...
         if(!isNaN(param1) && !isNaN(param2))
         {
            if(!(_loc10_ = calcUBoundsToFitTBounds(param1,param2,param3,param6,param7,param8,param9)))
            {
               if((_loc10_ = calcUBoundsToFitTBoundsWidth(param1,param3,param4,param5,param6,param7,param8,param9)) && transformSize(_loc10_.x,_loc10_.y,param3).y > param2)
               {
                  if((_loc10_ = calcUBoundsToFitTBoundsHeight(param2,param3,param4,param5,param6,param7,param8,param9)) && transformSize(_loc10_.x,_loc10_.y,param3).x > param1)
                  {
                     _loc10_ = null;
                  }
               }
      ...
      public static function calcUBoundsToFitTBoundsHeight(param1:Number, param2:Matrix, param3:Number, param4:Number, param5:Number, param6:Number, param7:Number, param8:Number) : Point
      {
         ...
         var _loc11_:Number;
         if((_loc11_ = _loc9_ * _loc10_ >= 0 ? Number(_loc10_) : Number(-_loc10_)) != 0)
         {
            _loc18_ = 1 / _loc11_;
            _loc13_ = param3;
      ...
      private static function getConcatenatedMatrixHelper(param1:DisplayObject, param2:Boolean) : Matrix
      {
         ...
         while(param1 && param1.transform.matrix)
         {
            if((_loc4_ = param1.scrollRect) != null)
            {
               _loc3_.translate(-_loc4_.x,-_loc4_.y);
            }
            if(usesMarshalling && "moduleFactory" in param1)
            {
               if((_loc6_ = param1["moduleFactory"]) && _loc6_ !== lastModuleFactory && "info" in _loc6_)
               {
                  if((_loc7_ = _loc6_["info"]()["currentDomain"]) && _loc7_.hasDefinition("mx.core.UIComponent"))
                  {
            ...
            _loc5_ = uiComponentClass && param1 is uiComponentClass;
            if(param2 && _loc5_)
            {
