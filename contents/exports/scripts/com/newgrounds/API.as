...
package com.newgrounds
{
   ...
   public class API
   {
         ...
         switch(getCommandName(param1.command_id))
         {
            ...
            case "loadSaveFile":
               if(param1.success)
               {
                  ...
                  if(param1.file.keys && param1.file.keys.length)
                  {
                     _loc16_ = 0;
                  ...
                  if(param1.file.ratings && param1.file.ratings.length)
                  {
                     _loc16_ = 0;
            ...
            case "lookupSaveFiles":
               _loc7_ = [];
               if(param1.success && param1.files)
               {
                  _loc16_ = 0;
                  while(_loc16_ < param1.files.length)
                  {
                     ...
                     if(_loc17_.keys && _loc17_.keys.length)
                     {
                        _loc18_ = 0;
                     ...
                     if(_loc17_.ratings && _loc17_.ratings.length)
                     {
                        _loc18_ = 0;
      ...
      static function callListener(param1:String, param2:Boolean = true, param3:* = undefined) : void
      {
      ...
      private static function getPeriodAliases() : Object
      {
         ...
         var _loc1_:Object = new Object();
         for(_loc1_[period_aliases[_loc2_].alias] in period_aliases)
         {
         }
         return _loc1_;
      }
