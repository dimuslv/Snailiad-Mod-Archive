...
package com.newgrounds
{
   ...
   public class Medal
   {
      ...
      {
         return !!this._iconLoader ? uint(this._iconLoader.contentLoaderInfo.bytesLoaded) : uint(0);
      }
      
      public function get bytesTotal() : uint
      {
         return !!this._iconLoader ? uint(this._iconLoader.contentLoaderInfo.bytesTotal) : uint(0);
      }
